...
CREATE TABLE orders (
  ...
  status VARCHAR(50),
  created_at DATETIME,
  user_id INT NOT NULL, -- 필수적 일대일 관계 (Not Null)
...
CREATE TABLE payments (
  ...
  order_id INT NOT NULL UNIQUE, -- 필수적 일대일 관계
...
CREATE TABLE products (
	id INT AUTO_INCREMENT,
  name VARCHAR(50) UNIQUE NOT NULL, -- 후보키
...
CREATE TABLE order_details (
  ...
  UNIQUE (order_id, product_id) 
	-- 하나의 주문에 같은 상품이 중복으로 담기지 않게 고유 키 설정
  -- 한 주문에 하나의 상품이 여러개 담기는 경우 quantity로 관리할 수 있게 함
);
